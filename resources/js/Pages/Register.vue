    ...
    <div id="login-card" class="card">
        <div class="login_form">
            <div class="details">
                ...
                <div class="wrap">
                    ...
                    <div class="wrap">
                        ...
                        <input type="password" id="password_confirmation" placeholder="Confirm password" class="form-control" v-model="password_confirmation">
                    </div>
                    <button type="submit" class="button"><h1 class="sign">Create account!</h1></button>
                </form>
            </div>
            ...
            <div class="details-two">
                <h1 class="back">Welcome!</h1>
                <p class="log">Please create account to use the opportunities offered by our portal.</p>
                <h2 class="acc">You have an account?<br><router-link  :to="{ name : 'login' }">
                    {{ "Login" }}
                </router-link></h2>
            </div>
        </div>
