        ...
        <div class="login_form">
            <div class="details">
                ...
                <form autocomplete="off" @submit.prevent="login" method="post">
                    <div class="wrap">
                        <label>Email</label>
                        <input type="email" id="email" class="form-control" placeholder="Enter email" v-model="email" required>
                    </div>
                    <div class="wrap">
            ...
            <div class="details-two">
                ...
                <h2 class="acc">You don't have an account?<br><router-link  :to="{ name : 'register' }">
                    {{ "Register" }}
                </router-link></h2>
            </div>
        </div>
